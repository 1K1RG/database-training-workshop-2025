...
> **Note:** To try out the following commands, make sure you have completed the Day 2 setup guide through [this link](https://1k1rg.github.io/database-training-workshop-2025/pre-day-2).
...
This **avoids data duplication**. The organism’s details are stored only once, even if thousands of SNPs belong to the same organism.
