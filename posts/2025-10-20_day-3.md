...
![Ontology](images/stocks-ERD.png)  
...
- <a href="files/chado_dump.sql" download="chado_dump.sql">Download chado dump</a>
...
- Bulk insert library: [PgBulkInsert](https://github.com/PgBulkInsert/PgBulkInsert)
 – used to efficiently insert large genomic datasets into PostgreSQL.
...
- <a href="files/sample_list.txt" download="sample-list.txt">Download Sample List</a>
- <a href="files/pos_500_per_chr.txt" download="pos_500_per_chr.txt">Download Pos file</a>
